...
namespace iw4of
{
  ...
  uint32_t assets::write_in_stringtable(const std::string& text) const
  {
    ...
    print_error(std::format(
        "IW4OF is missing stringtable function and cannot store text {} from stringtable!",
        text));
    return 0xDEADC0DE;
  }
  ...
  std::string assets::read_from_stringtable(const uint32_t& index) const
  {
    ...
    print_error(std::format(
        "IW4OF is missing stringtable function and cannot read index {} from stringtable!",
        index));
  ...
  assets::assets(const params_t& params)
  {
    ...
    asset_interfaces[native::XAssetType::ASSET_TYPE_IMAGE] =
        new interfaces::igfximage(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_MATERIAL] =
        new interfaces::imaterial(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_TECHNIQUE_SET] =
        new interfaces::itechniqueset(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_PIXELSHADER] =
        new interfaces::ipixelshader(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_VERTEXSHADER] =
        new interfaces::ivertexshader(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_VERTEXDECL] =
        new interfaces::ivertexdecl(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_PHYSPRESET] =
        new interfaces::iphyspreset(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_XMODEL] =
        new interfaces::ixmodel(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_GFXWORLD] =
        new interfaces::igfxworld(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_GAMEWORLD_MP] =
        new interfaces::iglassworld(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_COMWORLD] =
        new interfaces::icomworld(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_LIGHT_DEF] =
        new interfaces::ilightdef(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_RAWFILE] =
        new interfaces::irawfile(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_MAP_ENTS] =
        new interfaces::imapents(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_CLIPMAP_MP] =
        new interfaces::iclipmap(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_SOUND] =
        new interfaces::isndalias(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_LOADED_SOUND] =
        new interfaces::iloadedsound(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_SOUND_CURVE] =
        new interfaces::isndcurve(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_FXWORLD] =
        new interfaces::ifxworld(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_FX] =
        new interfaces::ifx(this);
    asset_interfaces[native::XAssetType::ASSET_TYPE_XANIMPARTS] =
        new interfaces::ixanimparts(this);
  }
