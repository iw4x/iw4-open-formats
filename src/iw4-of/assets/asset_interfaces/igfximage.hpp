...
namespace iw4of::interfaces
{
	...
	public:
		igfximage(const iw4of::assets* assets) : asset_interface(assets) {}
	...
	private:
		...
		{
			return image != nullptr && image->category != native::GfxImageCategory::IMG_CATEGORY_LOAD_FROM_FILE && image->texture.loadDef;
		}

		std::filesystem::path get_special_file_name(const std::string& basename) const;
	};
}