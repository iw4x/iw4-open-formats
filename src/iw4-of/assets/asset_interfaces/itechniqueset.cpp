...
#if DEBUG
                    arg_json.AddMember(
                        "codeSampler_debug", RAPIDJSON_STR(native::Debug_MaterialTextureSourceNames[iw4_arg->u.codeSampler]), allocator);
#endif
