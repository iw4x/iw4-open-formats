...
namespace iw4of::interfaces
{
  struct igfxworld : asset_interface
  {
   ...
   private:
    void write(const native::GfxWorldDraw* dpvs_static,
               utils::stream* buffer) const;
    void write(const native::GfxWorld* world,
               const native::GfxWorldDpvsStatic* dpvs_static,
               utils::stream* buffer) const;
    ...
    bool read_dpvs_static(const native::GfxWorld* world,
                          native::GfxWorldDpvsStatic* asset,
                          utils::stream::reader* reader) const;
    bool read_gfx_world_draw(native::GfxWorldDraw* asset,
                             utils::stream::reader* reader) const;
  };
} // namespace iw4of::interfaces