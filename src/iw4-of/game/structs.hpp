...
#define NAMEOF(s) #s
  ...
  static_assert(ARRAYSIZE(Debug_MaterialTextureSourceNames) ==
                MaterialTextureSource::TEXTURE_SRC_CODE_COUNT);
  ...
  static_assert(ARRAYSIZE(Debug_MaterialShaderArgumentTypeName) ==
                MaterialShaderArgumentType::MTL_ARG_COUNT);
  ...
  static_assert(ARRAYSIZE(codeSamplerUpdateFrequency) ==
  ...
  static_assert(ARRAYSIZE(Debug_ShaderCodeConstantsNames) ==
                ShaderCodeConstants::CONST_SRC_TOTAL_COUNT);
